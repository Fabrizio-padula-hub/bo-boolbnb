                ...
                <td class="py-3 px-2">
                    ...
                    <div class="inline-flex items-center space-x-3">
                        ...
                        <a href="{{ route('admin.apartments.edit', ['apartment' => $apartment->slug]) }}" title="Modifica"
                            class="hover:text-amber-400"><svg xmlns="http://www.w3.org/2000/svg" fill="none"
                        ...
                        {{-- icona Elimina --}}
                        <a href="" title="Elimina" class="hover:text-red-800"><svg xmlns="http://www.w3.org/2000/svg"
